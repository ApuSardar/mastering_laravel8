...
<head>
        ...
        <meta charset="utf-8" />
        <title>Login | Online Shop Park</title>
                                ...
                                <div class="p-2">
                                    <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"  name="username" id="username" placeholder="Enter username" :value="old('username')" required autofocus />
                                        </div>
